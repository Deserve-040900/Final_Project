            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <h3 id="chudegt"><span className="agile_bts">๖ۣۜ𝓑.</span>𝓢𝓽𝓸𝓻𝓮 sẽ giúp bạn dễ dàng thỏa mãn ước mơ “giáo sư” theo cách ít tốn công sức nhất</h3>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <img src="images/about.jpeg" class="img-responsive" alt="" />
                    </div>
                </div>
            </div>
        </section>
